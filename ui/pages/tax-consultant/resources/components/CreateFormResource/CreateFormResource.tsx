...
import style from './CreateFormResource.module.scss'
      ...
      <div className={style.cardContainer}>
        <div className={style.header}>
          <h3 className={style.formTitle}>
            <FormattedMessage id='page.tax-consultant.resources.createForm.input.create'></FormattedMessage>
          </h3>
        </div>
        <Formik
        ...
        >
          {({ values, errors, touched }) => (
            <Form>
              <InputFormikApp
                labelID='page.tax-consultant.resources.createForm.input.create'
                type='text'
                name='title'
                // icon={'fileIcon'}
              />
              <TextareaFormikApp
                labelID='page.tax-consultant.resources.createForm.input.description'
                name='excerpt'
                // icon={'fileIcon'}
              />
              <div>
                ...
                >
                  <ButtonApp
                    ...
                    type='submit'
                    labelID='page.tax-consultant.resources.createForm.submit'
                  />
                </div>
              </div>
            </Form>
