    ...
    <div className={style.webinars}>
      ...
      <div className={style.filtersSearchContainer}>
        <SearchBar
          ...
          onFilter={(value: { search?: string; tags?: string }) => onFilter(value.search as string)}
        />
      </div>
      ...
      <div className={style.webinarsContainer}>
        <div className={style.webinars_items}>
          {webinars ? (
            <ul>
              {webinars.map((item) => (
                <li key={item.id}>
                  <ItemListWebinar
                    ...
                    chips={[
                      {
                        label: `${item.date?.toLocaleString(["es-ES"], {
                          day: "numeric",
                          month: "numeric",
                          year: "numeric",
                          hour: "numeric",
            ...
            <p>
              <FormattedMessage id={"page.webinars.empty"} />
            </p>
          )}
